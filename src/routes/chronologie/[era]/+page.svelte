...
<svelte:head>
	<title>{data.era.nameFr} — Grand Livre du Lore</title>
	<meta name="description" content={data.era.description} />
</svelte:head>
	...
	<div class="mx-auto max-w-3xl">
		...
		{:else}
			<div class="py-12 text-center text-text-muted">
				<p class="text-lg font-medium">Aucun article pour cette ère</p>
